DAILY OUTREACH PACKAGE

Produce today's outreach package for HealthDataLab (HDL):
...
1. OUTREACH MESSAGES (3 drafts): Write 3 personalised outreach messages targeting holistic health practitioners or practitioner organisations. For each:
   - Target: Practitioner type, association, or training organisation
   - Channel: Email or LinkedIn
   - Subject line (for emails)
   - Full message body (ready to send) — warm, collegial, value-first tone
...
2. FOLLOW-UP ACTIONS: Draft follow-up messages for practitioners who:
   ...
   - Showed interest but went quiet (check in, offer value)
   - Completed an HDL report but didn't engage further (ask for feedback, offer guidance)
   Apply the reciprocity gate — if someone has had 3 touches with no response, recommend moving on.

3. WARM LEADS: Types of practitioners or organisations most likely to engage right now. Consider:
   - IIPA members who attended Matthew's virtual symposium talk
   - Naturopaths already offering longevity services
   - Practitioners who've expressed interest in data-driven tools
   Suggest specific next steps for each type.

4. PIPELINE SUMMARY: Outline a simple pipeline tracker structure:
   - Signed up > Form complete > Email sent > Replied > Call booked > Call done > Enrolled
   - Recommend which stage needs the most attention today

All messages must be professional, warm, and personalised. Frame HDL as a professional development investment, not a software subscription. British English. No hype, no pressure — authentic, collegial, and generous.
