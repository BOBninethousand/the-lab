...
Produce today's intelligence briefing for Matthew D'haemer's businesses — HealthDataLab (HDL), IrisLab, and Altituding — covering:
...
2. MARKET SIGNALS: Trends, news, or regulatory changes in:
   - Longevity and anti-ageing market (global $29.8B, growing 8.2% CAGR)
...
3. OPPORTUNITY ALERTS: Potential practitioner communities, associations, conferences, or partnership openings. Focus on:
   - Naturopath and holistic health practitioner networks
   - Longevity-focused events or summits
   - Health practitioner training organisations
   - Wellness industry publications or podcasts seeking guests
   Include names and why they're relevant to HDL's practitioner-first strategy.

4. RECOMMENDED ACTIONS: Top 3 things Matthew should act on today based on the above. Prioritise by: (1) Revenue potential (2) Credibility/proof building (3) Distribution reach. Use the Hormozi principle: if it doesn't create value, reduce risk, or build proof — skip it.

Format as a structured briefing with clear headers. Be specific — names, numbers, links where possible. No waffle. British English.
